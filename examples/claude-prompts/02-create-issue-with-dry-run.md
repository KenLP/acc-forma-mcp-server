...
```json
{
  ...
  "next_step": "To execute this action, call tool \"issues_create\" again with the same inputs plus dry_run=false and approval_token=\"appr_01JXWXYZ...\". Token expires in 300s and is single-use."
}
```
